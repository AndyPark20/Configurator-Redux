...
const ExteriorSection = ({
  ...
  model,
  exteriorColor,
  userSelectedExtColor,
  userSelectedWheelName,
  userSelectedTrim,
  wheelSelection,
  intColor,
  sectionView,
  ...
  return (
    <div className="">
      <div>
        <h3 className="exterior-color-title">
          Exterior Color:
          <span className="selected-exterior-color">
            {userSelectedExtColor}
          </span>
        </h3>
      ...
      <div>
        <h3 className="exterior-color-title">
          Wheels:<span className="selected-wheel">{userSelectedWheelName}</span>
        </h3>
